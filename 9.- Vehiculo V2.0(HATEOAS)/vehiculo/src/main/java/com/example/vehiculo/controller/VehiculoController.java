...
//IMPORTACIÓN MANUAL PARA HATEOAS
...
public class VehiculoController {
    ...
    public EntityModel<Vehiculo> obtenerVehiculoPorID(@PathVariable int id_vehiculo) {
        Vehiculo vehiculo = vehiculoService.obtenerVehiculoPorID(id_vehiculo);
        Link obtenerTodosLink = linkTo(methodOn(VehiculoController.class).obtenerTodosLosVehiculos()).withRel("Obtener-todos-los-vehiculos.");
        Link EliminarVehiculo = linkTo(VehiculoController.class).slash(id_vehiculo).withRel("Eliminar-Vehiculo-por-ID.");
        return EntityModel.of(vehiculo,obtenerTodosLink,EliminarVehiculo);
